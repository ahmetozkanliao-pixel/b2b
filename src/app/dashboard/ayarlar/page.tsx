      ...
      <div className="mt-6 space-y-6">
        ...
        {!isProducer && (
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Talep Sahibi Firma</strong> — Platformu tamamen
            ücretsiz kullanıyorsunuz. İlan yayınlama ve başvuru yönetimi için herhangi bir
            ücret alınmaz.
          </div>
        )}
